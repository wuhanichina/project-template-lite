...
| 符号 | 含义 | 类型 | 维度/单位 | 代码变量 |
| --- | --- | --- | --- | --- |
| $x$ | 【待补充：状态、决策或估计对象】 | 【待补充】 | 【待补充】 | `x` |
| $u$ | 控制变量 | 【待补充】 | 【待补充】 | `u` |
| $\xi$ | 不确定变量 | 【待补充】 | 【待补充】 | `xi` |
| $\theta$ | 模型参数或校准参数 | 【待补充】 | 【待补充】 | `theta` |
| $f(x,\theta)$ | 核心目标、约束或评价函数 | 【待补充】 | 【待补充】 | `objective` / `metric` |

## 基本假设

| 编号 | 假设 | 使用位置 | 建模前提 | 证据状态 |
| --- | --- | --- | --- | --- |
| A1 | 【待补充】 | 模型/推导/算例 | 【待补充】 | 尚未验证 |
| A2 | 【待补充】 | 模型/推导/算例 | 【待补充】 | 尚未验证 |
| A3 | 【待补充】 | 模型/推导/算例 | 【待补充】 | 尚未验证 |
